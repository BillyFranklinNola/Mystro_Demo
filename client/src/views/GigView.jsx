            ...
            <div className="d-flex justify-content-between">
                <div className="col-4">
                    ...
                    <div className="border border-3 border-secondary rounded p-2 text-center text-white"> 
                        ...
                        <p>
                            {gig.city}, {gig.state} {gig.zipCode}
                        </p>
                    </div>
                </div>
                ...
                <div className="col-4">
                    ...
                    <div className="mt-3">
                        <GigWeather gig={gig} setGig={setGig} gigLattitude={gigLattitude} setGigLattitude={setGigLattitude} gigLongitude={gigLongitude} setGigLongitude={setGigLongitude}/>
                    </div>
                </div>
            </div>
        </div>
